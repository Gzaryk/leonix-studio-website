...
export const metadata: Metadata = {
  title: "Support",
  description: "Get help with your Leonix Studio purchase — through Discord, email, or our FAQ.",
};
...
const channels = [
  {
    ...
    description: "Get the fastest response from our team and community. Recommended for install help.",
    action: "Join Discord",
  ...
  },
  {
    icon: Mail,
    title: "Email Us",
    description: "For billing, licensing, or anything you'd rather not put in a public server.",
  ...
  },
  {
    icon: LifeBuoy,
    title: "Read the FAQ",
    description: "Most installation and licensing questions are already answered here.",
    action: "View FAQ",
    href: "/faq",
    external: false,
  },
        ...
        <div className="grid gap-6 sm:grid-cols-3">
          {channels.map((channel) => (
            ...
            >
              ...
              <h3 className="font-display text-lg font-semibold">{channel.title}</h3>
              ...
              {channel.external ? (
                ...
                >
                  {channel.action} <ArrowUpRight className="h-3.5 w-3.5" />
                </a>
              ) : (
                <Link
                  href={channel.href}
