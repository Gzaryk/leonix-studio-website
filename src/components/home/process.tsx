...
const steps = [
  {
    ...
    description: "Explore high-fidelity MLOs and scripts built specifically for serious roleplay servers.",
  },
  {
    icon: CreditCard,
    title: "Secure checkout",
    description: "Purchase safely through Tebex — the same trusted platform used by top FiveM stores.",
  },
  {
    icon: DownloadCloud,
    title: "Instant delivery",
    description: "Get immediate access to your files along with a full installation guide.",
  },
  {
    icon: Rocket,
    title: "Deploy & elevate",
    description: "Drop it into your server and give your community a location worth roleplaying in.",
  },
];
