        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          >
            <Link href="/" className="flex items-center gap-2" data-cursor-hover>
              <span className="relative flex h-8 w-8 items-center justify-center rounded-lg bg-gradient-to-br from-primary to-secondary font-display text-sm font-bold text-background">
                L
              </span>
            ...
            <div className="hidden items-center gap-3 md:flex">
              <Button asChild size="sm" variant="secondary">
                <a href={siteConfig.discord} target="_blank" rel="noreferrer">
                  Discord <ArrowUpRight className="h-3.5 w-3.5" />
                </a>
              </Button>
