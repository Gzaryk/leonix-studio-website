          ...
          >
            <div className="flex items-center justify-between border-b border-white/10 px-6 py-5">
              <h2 className="font-display text-lg font-semibold">
                Cart {itemCount > 0 && <span className="text-muted">({itemCount})</span>}
              </h2>
              <button
                onClick={onClose}
                data-cursor-hover
            ...
            {items.length === 0 ? (
              <div className="flex flex-1 flex-col items-center justify-center gap-4 px-6 text-center">
                ...
                <div>
                  <h3 className="font-display text-base font-semibold">Your cart is empty</h3>
              ...
              <>
                ...
                <div className="border-t border-white/10 px-6 py-5">
                  ...
                  <p className="mb-4 text-xs text-muted">Taxes and fees calculated at checkout.</p>
                    ...
                    <Button
                      ...
                      onClick={() => {
                        ...
                        const params = new URLSearchParams({
                          items: JSON.stringify(items.map((i) => ({ slug: i.product.slug, quantity: i.quantity }))),
                        });
